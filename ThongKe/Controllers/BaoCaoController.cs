...
using ThongKe.Models.SaleTheoNgayDi;
...
namespace ThongKe.Controllers
{
    public class BaoCaoController : BaseController
    {
        ...
        /////////////////////////////////////// Sale theo quay ///////////////////////////////////////////////////////////////////
        public async Task<IActionResult> SaleTheoQuay(string tungay = null, string denngay = null, string chiNhanh = null, string khoi = null)
        {
            ...
            try
            {
                ...
                // list dailyxuatve
                HttpContext.Session.Set("nhanVien", list.Select(x => x.Nguoixuatve).ToList());
        ...
        [HttpPost]
        public async Task<IActionResult> SaleTheoQuayPost(string tungay, string denngay, string chinhanh, string khoi)//(string tungay,string denngay, string daily)
        {
        ...
        public IActionResult SaleTheoQuayChiTietToExcel_All(string tungay, string denngay, string chinhanh, string khoi)
        {
            var listNhanVien = HttpContext.Session.Get<List<string>>("nhanVien");
            try
            {
                //khoi = String.IsNullOrEmpty(khoi) ? Session["khoi"].ToString() : khoi;
                string fromTo = "";
                ...
                xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU SALE THEO NGÀY BÁN";
                xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
                xlSheet.Cells[2, 1, 2, 9].Merge = true;
                if (tungay == denngay)
                {
                ...
                var doanhthuQuayChitietGroupByNguoiTaos = dPlus.Select(x => new DoanhthuSaleChitietGroupByNguoiTao()
                {
                    NguoiTao = x.Key,
                    DoanhthuSaleChitiets = x
                ...
                if (d != null)
                {
                    foreach (var item in doanhthuQuayChitietGroupByNguoiTaos)
                    {
                        foreach (var vm in item.DoanhthuSaleChitiets)
                        {
                            xlSheet.Cells[iRowIndex, 1].Value = idem;
                            TrSetCellBorder(xlSheet, iRowIndex, 1, ExcelBorderStyle.Dotted, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 10, FontStyle.Regular);
                            xlSheet.Cells[iRowIndex, 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
        ...
        public IActionResult SaleTheoNgayDiPost(string tungay, string denngay, string chinhanh, string khoi)
        {
            ...
            List<DoanhthuSaleQuay> d = _unitOfWork.thongKeRepository.SaleTheoNgayDiPost(tungay, denngay, chinhanh, khoi);
            var result = (from p in d
                          group p by p.Nguoixuatve into g
                          select new SaleTheoNgayDiGroupByNXV
                          {
                              NguoiXuatVe = g.Key,
                              DoanhthuSaleQuays = g.ToList()
                          }).ToList();
            //du lieu
            int iRowIndex = 6;
            int idem = 1;
            ...
            if (d != null)
            {
                ...
                {
                    foreach (var vm in item.DoanhthuSaleQuays)
                    {
                        xlSheet.Cells[iRowIndex, 1].Value = idem;
                        xlSheet.Cells[iRowIndex, 1].Style.Font.SetFromFont(new Font("Times New Roman", 11, FontStyle.Regular));
                        xlSheet.Cells[iRowIndex, 2].Value = vm.Nguoixuatve;
                        xlSheet.Cells[iRowIndex, 2].Style.Font.SetFromFont(new Font("Times New Roman", 11, FontStyle.Regular));
                        xlSheet.Cells[iRowIndex, 3].Value = vm.Chinhanh;
                        xlSheet.Cells[iRowIndex, 3].Style.Font.SetFromFont(new Font("Times New Roman", 11, FontStyle.Regular));
                        xlSheet.Cells[iRowIndex, 4].Value = vm.Doanhso;
                        xlSheet.Cells[iRowIndex, 4].Style.Font.SetFromFont(new Font("Times New Roman", 11, FontStyle.Regular));
                        xlSheet.Cells[iRowIndex, 5].Value = vm.Thucthu;
                        xlSheet.Cells[iRowIndex, 5].Style.Font.SetFromFont(new Font("Times New Roman", 11, FontStyle.Regular));

                        iRowIndex ++;
                        idem += 1;
                    }
                    
                    xlSheet.Cells[iRowIndex, 3].Value = "Tổng cộng:";
                    xlSheet.Cells[iRowIndex, 4].Value = item.DoanhthuSaleQuays.Sum(x => x.Doanhso ?? 0); // doanhso
                    xlSheet.Cells[iRowIndex, 5].Value = item.DoanhthuSaleQuays.Sum(x => x.Thucthu ?? 0); // thucthu
                    setBorder(iRowIndex, 1, iRowIndex, 5, xlSheet);
                    xlSheet.Cells[iRowIndex, 3, iRowIndex, 5].Style.Font.SetFromFont(new Font("Times New Roman", 12, FontStyle.Bold));
                    iRowIndex++;
                }
            }
            else
            ...
            // Sum tổng tiền
            xlSheet.Cells[iRowIndex, 3].Value = "Tổng:";
            xlSheet.Cells[iRowIndex, 4].Value = d.Sum(x => x.Doanhso ?? 0);
            xlSheet.Cells[iRowIndex, 5].Value = d.Sum(x => x.Thucthu ?? 0);
            xlSheet.Cells[iRowIndex, 3, iRowIndex, 5].Style.Font.SetFromFont(new Font("Times New Roman", 12, FontStyle.Bold));

            NumberFormat(6, 4, iRowIndex , 5, xlSheet);
            xlSheet.Cells[5, 1, iRowIndex, 5].Style.Border.Left.Style = ExcelBorderStyle.Thin; // Border
            xlSheet.Cells[5, 1, iRowIndex, 5].Style.Border.Top.Style = ExcelBorderStyle.Thin; // Border
            xlSheet.Cells[5, 1, iRowIndex, 5].Style.Border.Right.Style = ExcelBorderStyle.Thin; // Border
            xlSheet.Cells[5, 1, iRowIndex, 5].Style.Border.Bottom.Style = ExcelBorderStyle.Thin; // Border
        ...
        public IActionResult SaleTheoNgayDiChiTietToExcel(string tungay, string denngay, string nhanvien, string chinhanh, string khoi)
        {
            try
            {
                ...
                xlSheet.Column(8).Width = 20;// thuc thu
                xlSheet.Column(9).Width = 35;// sales
                xlSheet.Column(10).Width = 20;// Loaitour
                ...
                xlSheet.Cells[3, 1].Style.Font.SetFromFont(new Font("Times New Roman", 14, FontStyle.Bold));
                setCenterAligment(2, 1, 3, 10, xlSheet);
                ...
                if (d != null)
                {
                    foreach (var vm in d)
                    {
                        ...
                        xlSheet.Cells[iRowIndex, 10].Value = vm.LoaiTour;
                        //TrSetCellBorder(xlSheet, iRowIndex, 4, ExcelBorderStyle.Dotted, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 10, FontStyle.Regular);
                ...
                setCenterAligment(6, 1, 6 + d.Count(), 3, xlSheet);
                setCenterAligment(6, 6, 6 + d.Count(), 6, xlSheet);
                setFontSize(6, 1, 6 + d.Count(), 10, 10, xlSheet);
                //xlSheet.View.FreezePanes(6, 20);
        ...
        public IActionResult SaleTheoNgayDiChiTietToExcel_All(string tungay, string denngay, string chinhanh, string khoi)
        {
            var listNhanVien = HttpContext.Session.Get<List<string>>("nhanVien");
            try
            {
                ...
                xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU SALE THEO NGÀY ĐI";
                xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
                ...
                if (d != null)
                {
                    foreach (var item in doanhthuSaleChitietGroupByNguoiTaos)
                    {
                        foreach (var vm in item.DoanhthuSaleChitiets)
                        {
                            xlSheet.Cells[iRowIndex, 1].Value = idem;
                ...
                string sFilename = "DoanhThuSale_" + "_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";
        ...
        [HttpPost]
        public IActionResult SaleTheoTuyenThamQuanPost(string tungay, string denngay, string chiNhanh, string tuyentq, string khoi)
        {
            if (tungay == null || denngay == null)
            {
            ...
            var d = _baoCaoService.ListSaleTheoTuyenThamQuan(tungay, denngay, chiNhanh, tuyentq, khoi); // _unitOfWork.thongKeRepository.ListSaleTheoTuyenThamQuan(tungay, denngay, tuyentq, khoi);// Session["fullName"].ToString());
            ...
            {
                SetAlert("No sale.", "warning");
                return RedirectToAction(nameof(SaleTheoTuyenThamQuan));
            }
            ...
            setFontSize(6, 1, 6 + d.Count(), 6, 10, xlSheet);
            setBorder(5, 1, dong, 6, xlSheet);
        ...
        public IActionResult SaleTheoTuyenThamQuanChiTietToExcel(string tungay, string denngay, string nhanvien, string tuyentq, string khoi)
        {
            try
            {
                ...
                xlSheet.Column(8).Width = 20;//thuc thu
                xlSheet.Column(9).Width = 35;//sales
                xlSheet.Column(10).Width = 20;//Loại tour
            ...
            string chinhanh = null, string khoi = null)
        {
            ...
            var user = HttpContext.Session.Get<Users>("loginUser");
            var dtSaleTuyenVM = new SaleTheoLoaiTourViewModel();
            //dtSaleTuyenVM.TuNgay = tungay;
            //dtSaleTuyenVM.DenNgay = denngay;
            //dtSaleTuyenVM.Khoi = khoi;
            ...
            try
            {
                ...
                if (tungay == null || denngay == null)
                {
                    SetAlert("Ngày tháng không được để trống", "error");
                    return View();
                }
            ...
            {
                SetAlert("Lỗi định dạng ngày tháng", "error");
                return View("SaleTheoLoaiTour", dtSaleTuyenVM);
            }

        }

        [HttpPost]
        public async Task<IActionResult> SaleTheoLoaiTourPost(string tungay, string denngay, string chiNhanh, string khoi)
        {
            DateTime dateTime;
            if (tungay == null || denngay == null || !DateTime.TryParse(tungay, out dateTime) || !DateTime.TryParse(denngay, out dateTime))
            {
            ...
            xlSheet.Column(3).Width = 10;// chinhanh
            xlSheet.Column(4).Width = 20;// doanh so
            xlSheet.Column(5).Width = 20;// thuc thu

            xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU SALE THEO SỰ KIỆN";
            xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
            xlSheet.Cells[2, 1, 2, 5].Merge = true;
            setCenterAligment(2, 1, 2, 5, xlSheet);
            // dinh dang tu ngay den ngay
            ...
            string sFilename = "DoanhThuSaleTheoSuKien_" + khoi + "_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";
        ...
        public IActionResult SaleTheoLoaiTourChiTietToExcel(string tungay, string denngay, string chinhanh, string tuyentq, string khoi)
        {
            try
            {
                ...
                xlSheet.Column(3).Width = 13;// Bắt đầu
                xlSheet.Column(4).Width = 13;// Kết thúc
                xlSheet.Column(5).Width = 7;// SK
                xlSheet.Column(6).Width = 20;// Sgtcode
                xlSheet.Column(7).Width = 25;// Tuyet TQ
                xlSheet.Column(8).Width = 13;// Ngày xuất vé
                xlSheet.Column(9).Width = 25;// Người xuất vé
                xlSheet.Column(10).Width = 15;// Doanh số
                xlSheet.Column(11).Width = 30;// Đại lý xuất vé

                xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU SALE SỰ KIỆN THEO TUYẾN " + tuyentq.ToUpper();
                xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
                xlSheet.Cells[2, 1, 2, 10].Merge = true;
                if (tungay == denngay)
                {
                ...
                xlSheet.Cells[5, 1].Value = "STT";
                xlSheet.Cells[5, 2].Value = "Code CN";
                xlSheet.Cells[5, 3].Value = "Bắt đầu";
                xlSheet.Cells[5, 4].Value = "Kết thúc";
                xlSheet.Cells[5, 5].Value = "SK";
                xlSheet.Cells[5, 6].Value = "Sgtcode";
                xlSheet.Cells[5, 7].Value = "Tuyet TQ";
                xlSheet.Cells[5, 8].Value = "Ngày xuất vé";
                xlSheet.Cells[5, 9].Value = "Người xuất vé";
                xlSheet.Cells[5, 10].Value = "Doanh số";
                xlSheet.Cells[5, 11].Value = "Đại lý xuất vé";
                ...
                if (d.Count() > 0)
                {
                    foreach (var vm in d)
                    {
                        ...
                        xlSheet.Cells[iRowIndex, 3].Value = vm.Batdau;
                        ...
                        xlSheet.Cells[iRowIndex, 4].Value = vm.Ketthuc;
                        ...
                        xlSheet.Cells[iRowIndex, 7].Value = vm.Tuyentq;
                        ...
                        xlSheet.Cells[iRowIndex, 8].Value = vm.Ngayxuatve;
                        ...
                        xlSheet.Cells[iRowIndex, 11].Value = vm.Dailyxuatve;
                ...
                {
                    SetAlert("No sale.", "warning");
                    return RedirectToAction(nameof(SaleTheoLoaiTour), new { tungay, denngay, chinhanh, khoi });
                }
                ...
                DateFormat(6, 3, dong, 4, xlSheet);
                DateFormat(6, 8, dong, 8, xlSheet);
                setBorder(5, 1, 5 + d.Count(), 11, xlSheet);
                setFontBold(5, 1, 5, 10, 12, xlSheet);
                //setFontSize(6, 1, 6 + d.Count(), 10, 11, xlSheet);
                ...
                string sFilename = "DoanhThuSaleSuKienTheoTuyen_" + tuyentq + "_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";
        ...
        ////////////////////////////////////// Quay Theo Ngay Ban ////////////////////////////////////////////////////////////////////////////
        public async Task<IActionResult> QuayTheoNgayBan(string tungay = null, string denngay = null, string chiNhanh = null,
            string khoi = null)
        {
        ...
        //public IActionResult QuayTheoNgayBanChiTietToExcel_All(string tungay, string denngay, string chinhanh, string khoi)
        //{
        //    var listDaiLyXuatVe = HttpContext.Session.Get<List<string>>("daiLyXuatVe");
        //    try
        //    {
        //        //khoi = String.IsNullOrEmpty(khoi) ? Session["khoi"].ToString() : khoi;
        //        string fromTo = "";
        ...
        //        xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU THEO NGÀY BÁN";
        //        xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
        //        xlSheet.Cells[2, 1, 2, 10].Merge = true;
        //        setCenterAligment(2, 1, 2, 10, xlSheet);
        //        // dinh dang tu ngay den ngay
        ...
        //        int dong = 5;
        //        //var d = _unitOfWork.thongKeRepository.QuayTheoNgayBanToExcel_All(tungay, denngay, chinhanh, khoi);// Session["fullName"].ToString());

        //        List<DoanhthuQuayChitiet> d = new List<DoanhthuQuayChitiet>();
        //        foreach (var item in listDaiLyXuatVe)
        //        {
        //            var doanhthuQuayChitiets = _unitOfWork.thongKeRepository.QuayTheoNgayBanChiTietToExcel(tungay, denngay, item, chinhanh, khoi);

        //            d.AddRange(doanhthuQuayChitiets);
        //        }
        //        var dPlus = d.GroupBy(x => x.Nguoiban);
        //        var doanhthuQuayChitietGroupByNguoiTaos = dPlus.Select(x => new DoanhthuQuayChitietGroupByNguoiTao()
        //        {
        //            NguoiTao = x.Key,
        //            DoanhthuQuayChitiets = x
        ...
        //            foreach(var item in doanhthuQuayChitietGroupByNguoiTaos)
        //            {
        //                foreach (var vm in item.DoanhthuQuayChitiets)
        //                {
        //                    xlSheet.Cells[iRowIndex, 1].Value = idem;
        //                    TrSetCellBorder(xlSheet, iRowIndex, 1, ExcelBorderStyle.Dotted, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 10, FontStyle.Regular);
        //                    xlSheet.Cells[iRowIndex, 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
        ...
        /////////////////////////////////////// Quay Theo ngay di ///////////////////////////////////////////////////////////////////////////
        public async Task<IActionResult> QuayTheoNgayDi(string tungay = null, string denngay = null, string chiNhanh = null,
            string khoi = null)
        {
            ...
            try
            {
                ...
                //// list dailyxuatve
                //HttpContext.Session.Set("daiLyXuatVe_TheoNgayDi", list.Select(x => x.Dailyxuatve).ToList());
        ...
        //public IActionResult QuayTheoNgayDiChiTietToExcel_All(string tungay, string denngay, string quay, string chinhanh, string khoi)
        //{
        //    var listDaiLyXuatVe = HttpContext.Session.Get<List<string>>("daiLyXuatVe_TheoNgayDi");
        //    try
        //    {
        //        //khoi = String.IsNullOrEmpty(khoi) ? Session["khoi"].ToString() : khoi;
        //        string fromTo = "";
        ...
        //        foreach (var item in listDaiLyXuatVe)
        //        {
        //            var doanhthuQuayChitiets = _unitOfWork.thongKeRepository.QuayTheoNgayDiChiTietToExcel(tungay, denngay, item, chinhanh, khoi);
        ...
        /////////////////////////////////////// Doan Theo ngay di ///////////////////////////////////////////////////////////////////////////
        public async Task<IActionResult> DoanTheoNgayDi(string tungay = null, string denngay = null, string chiNhanh = null, string khoi = null)
        {
        ...
        public IActionResult DoanTheoNgayDiPost(string tungay, string denngay, string chinhanh, string khoi)//(string tungay,string denngay, string daily)
        {
            ...
            xlSheet.Column(8).Width = 25;// Thực thu
        ...
        /////////////////////////////////////// TuyentqTheoNgayBan ///////////////////////////////////////////////////////////////////////////
        public async Task<IActionResult> TuyentqTheoNgayBan(string tungay = null, string denngay = null, string chiNhanh = null, string khoi = null)
        {
        ...
        public IActionResult TuyentqTheoNgayBanPost(string tungay, string denngay, string chinhanh, string khoi)//(string tungay,string denngay, string daily)
        {
            if (tungay == null || denngay == null)
            {
                return RedirectToAction("TuyentqTheoNgayBan");
            }
            try
            {
                DateTime.Parse(tungay);
            ...
            {
                SetAlert("No sale.", "warning");
                return RedirectToAction(nameof(TuyentqTheoNgayBan));
            }
        ...
        public IActionResult TuyentqTheoNgayBanChiTietToExcel(string tungay, string denngay, string tuyentq, string chinhanh, string khoi)
        {
            try
            {
                //khoi = String.IsNullOrEmpty(khoi) ? Session["khoi"].ToString() : khoi;
                ...
                xlSheet.Column(6).Width = 20;// Bắt đầu 
                xlSheet.Column(7).Width = 20;// Kết thúc
                xlSheet.Column(8).Width = 40;// Đại lý xuất vé
                xlSheet.Column(9).Width = 10;// Số khách
                xlSheet.Column(10).Width = 20;// Doanh thu
                xlSheet.Column(11).Width = 20;// Ngày bán


                xlSheet.Cells[2, 1].Value = "BÁO CÁO DOANH THU THEO NGÀY BÁN TUYẾN " + tuyentq;
                xlSheet.Cells[2, 1].Style.Font.SetFromFont(new Font("Times New Roman", 16, FontStyle.Bold));
                xlSheet.Cells[2, 1, 2, 11].Merge = true;
                setCenterAligment(2, 1, 2, 11, xlSheet);
                // dinh dang tu ngay den ngay
                if (tungay == denngay)
                {
                    fromTo = "Ngày: " + tungay;
                ...
                int dong = 5;
                var d = _unitOfWork.thongKeRepository.TuyentqTheoNgayBanChiTietToExcel(tungay, denngay, chinhanh, tuyentq, khoi);// Session["fullName"].ToString());
                ...
                setFontSize(6, 1, 6 + d.Count(), 11, 12, xlSheet);
                setBorder(5, 1, 5 + d.Count(), 11, xlSheet);
                setFontBold(5, 1, 5, 11, 12, xlSheet);

                // canh giưa cot stt
                setCenterAligment(6, 1, 6 + d.Count(), 2, xlSheet);

                setBorder(dong, 9, dong, 11, xlSheet);
                setFontBold(dong, 9, dong, 11, 12, xlSheet);
                // canh giưa cot ngay di va ngày ve
                ...
                DateFormat(6, 11, 6 + d.Count(), 11, xlSheet);
        ...
        public async Task<IActionResult> TuyentqTheoNgayDi(string tungay = null, string denngay = null, string chiNhanh = null, string khoi = null)
        {
        ...
        public async Task<IActionResult> TuyentqTheoQuy()
        {
        ...
        /////////////////////////////////////// Khach le he thong ///////////////////////////////////////////////////////////////////////////
        public async Task<IActionResult> KhachLeHeThong(string tungay = null, string denngay = null, string chiNhanh = null,
            string khoi = null)
        {
        ...
        /////////////////////////////////////// Khach Huy ///////////////////////////////////////////////////////////////////
        public async Task<IActionResult> KhachHuy(string tungay = null, string denngay = null, string chiNhanh = null, string khoi = null)
        {
        ...
        public IActionResult KinhDoanhOnlineNgayDiPost(string tungay, string denngay, string khoi)
        {
            ...
            xlSheet.Column(12).Width = 30;//  DAI LY 
            xlSheet.Column(13).Width = 20;//  KENH GD
            xlSheet.Column(14).Width = 20;//  CN
            xlSheet.Column(15).Width = 15;//  TRANG THAI
            ...
            xlSheet.Cells[5, 12].Value = "Đại lý";
            xlSheet.Cells[5, 13].Value = "Kênh GD";
            xlSheet.Cells[5, 14].Value = "CN";
            xlSheet.Cells[5, 15].Value = "Trạng thái";
            xlSheet.Cells[5, 16].Value = "Ngày tạo";
            ...
            if (d != null)
            {
                foreach (var vm in d)
                {
                    ...
                    xlSheet.Cells[iRowIndex, 14].Value = vm.Chinhanh;
                    ...
                    xlSheet.Cells[iRowIndex, 15].Value = vm.Trangthai;
                    ...
                    xlSheet.Cells[iRowIndex, 16].Value = vm.Ngaytao.Value.ToString("dd/MM/yyyy");
            ...
            // định dạng số
            NumberFormat(6, 10, 6 + d.Count(), 10, xlSheet);
            setFontSize(6, 1, 6 + d.Count(), 16, 12, xlSheet);
            setBorder(5, 1, 5 + d.Count(), 16, xlSheet);
            setFontBold(5, 1, 5, 10, 12, xlSheet);
            ...
            string Macn = null, string khoi = null)
        {
            ...
            BaoCaoVM.Dmchinhanhs = _baoCaoService.GetAllChiNhanh();
            ...
            try
            {
                ...
                {
                    return View("DoanhSoTheoSale", BaoCaoVM);
                }
                    ...
                    case "IB":
                        if (user.RoleId == 8) // 8: admins: lay het
                        {
                            BaoCaoVM.TourIBDTOs = _baoCaoService.DoanhSoTheoSale_IB(searchFromDate, searchToDate,
                                    BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == Macn), new List<string>(), "");
                        ...
                        else
                        {
                            ...
                            BaoCaoVM.TourIBDTOs = (phongBanQL.Count > 0) ? _baoCaoService.DoanhSoTheoSale_IB(searchFromDate, searchToDate,
                                        BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == Macn), phongBanQL, "") :
                                        _baoCaoService.DoanhSoTheoSale_IB(searchFromDate, searchToDate,
            ...
            string Macn = null, string khoi = null)
        {
            ...
            if (searchFromDate == null || searchToDate == null)
            {
                return RedirectToAction("DoanhSoTheoSale");
            }
            try
            {
            ...
            {
                case "IB":
                    if (BaoCaoVM.TourIBDtosGroupByNguoiTaos != null)
                    {
                        foreach (var vm in BaoCaoVM.TourIBDtosGroupByNguoiTaos)
                        {
                            foreach (var item in vm.TourIBDTOs)
                            {
                                ...
                                xlSheet.Cells[dong, 8].Value = item.SoKhachTT;
                                ...
                                xlSheet.Cells[dong, 9].Value = item.DoanhThuTT;
                ...
                case "ND":
                    if (BaoCaoVM.TourNDDtosGroupByNguoiTaos != null)
                    {
                ...
                case "OB":
                    if (BaoCaoVM.TourOBDtosGroupByNguoiTaos != null)
                    {
                                              ...
                                              string maCn = null, string khoi = null)
        {
            ...
            switch (khoi)
            {
                case "IB":
                    ...
                    else
                    {
                        ...
                        // 1
                        BaoCaoVM.TourBaoCaoTheoThangs1_IB = (phongBanQL.Count > 0) ?
                            TourBaoCaoTheoThangViewModels_IB(tuThang1, denThang1, nam1,
                            BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == maCn), phongBanQL, "") :
                            TourBaoCaoTheoThangViewModels_IB(tuThang1, denThang1, nam1,
                            BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == maCn), new List<string>(), user.Username);
                        // 1
                        ...
                        // 2
                        BaoCaoVM.TourBaoCaoTheoThangs2_IB = (phongBanQL.Count > 0) ?
                            TourBaoCaoTheoThangViewModels_IB(tuThang2, denThang2, nam2,
                            BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == maCn), phongBanQL, "") :
                            TourBaoCaoTheoThangViewModels_IB(tuThang2, denThang2, nam2,
                            BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == maCn), new List<string>(), user.Username);
                        // 2
                ...
                case "ND":
                    ...
                    //1
                    BaoCaoVM.TourBaoCaoTheoThangs1_ND = user.RoleId == 9 ?
                        TourBaoCaoTheoThangViewModels_ND(tuThang1, denThang1, nam1, maCn, user.Username) :
                        TourBaoCaoTheoThangViewModels_ND(tuThang1, denThang1, nam1, maCn, "");
                    //1

                    //2
                    BaoCaoVM.TourBaoCaoTheoThangs2_ND = user.RoleId == 9 ?
                        TourBaoCaoTheoThangViewModels_ND(tuThang2, denThang2, nam2, maCn, user.Username) :
                        TourBaoCaoTheoThangViewModels_ND(tuThang2, denThang2, nam2, maCn, "");
                    //2
                    break;
                ...
                case "OB":
                    ...
                    //1
                    BaoCaoVM.TourBaoCaoTheoThangs1_OB = user.RoleId == 9 ?
                        TourBaoCaoTheoThangViewModels_OB(tuThang1, denThang1, nam1, maCn, user.Username) :
                        TourBaoCaoTheoThangViewModels_OB(tuThang1, denThang1, nam1, maCn, "");
                    //1

                    //2
                    BaoCaoVM.TourBaoCaoTheoThangs2_OB = user.RoleId == 9 ?
                        TourBaoCaoTheoThangViewModels_OB(tuThang2, denThang2, nam2, maCn, user.Username) :
                        TourBaoCaoTheoThangViewModels_OB(tuThang2, denThang2, nam2, maCn, "");
                    //2
            ...
            //                // do tourob ko co daily -> lay theo chinhanh
            //                // do saledoan ND ko co STN => STN = STS
            //                var maCn2 = user.Chinhanh == "STN" ? "STS" : user.Chinhanh;
            //                maCns = new List<string>();
            //                maCns.Add(maCn2);
            //                //1
            //                BaoCaoVM.TourBaoCaoTheoThangs1_ND = TourBaoCaoTheoThangViewModels_OB(tuThang1, denThang1, nam1, maCns, user.Username);
            //                //1

            //                //2
            //                BaoCaoVM.TourBaoCaoTheoThangs2_ND = TourBaoCaoTheoThangViewModels_OB(tuThang2, denThang2, nam2, maCns, user.Username);
            //                //2
        ...
        public async Task<IActionResult> DoanhSoTheoThangExcel(string tuThang1, string denThang1, string nam1,
                                              string tuThang2, string denThang2, string nam2,
                                              string maCn = null, string khoi = null)
        {
            ...
            try
            {
                ...
                {
                    case "IB":
                        var excelPackage_IB = DoanhThuTheoThangExcelResult(thangNam1, thangNam2, BaoCaoVM.TourBaoCaoTheoThangs1_IB, BaoCaoVM.TourBaoCaoTheoThangs2_IB);
                        fileContents = excelPackage_IB.GetAsByteArray();
                        return File(
                        fileContents: fileContents,
                        contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                        fileDownloadName: "DoanhSoTheoThang_IB_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");

                    case "ND":
                        var excelPackage_ND = DoanhThuTheoThangExcelResult(thangNam1, thangNam2, BaoCaoVM.TourBaoCaoTheoThangs1_ND, BaoCaoVM.TourBaoCaoTheoThangs2_ND);
                        fileContents = excelPackage_ND.GetAsByteArray();
                        return File(
                        fileContents: fileContents,
                        contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                        fileDownloadName: "DoanhSoTheoThang_ND_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");

                    case "OB":
                        var excelPackage_OB = DoanhThuTheoThangExcelResult(thangNam1, thangNam2, BaoCaoVM.TourBaoCaoTheoThangs1_OB, BaoCaoVM.TourBaoCaoTheoThangs2_OB);
                        fileContents = excelPackage_OB.GetAsByteArray();
                        return File(
                        fileContents: fileContents,
                        contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                        fileDownloadName: "DoanhSoTheoThang_OB_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");
                                                          ...
                                                          IEnumerable<TourBaoCaoTheoThangViewModel> tourBaoCaoTheoThangViewModels2)
        {
            ...
            for (int i = 0; i <= 11; i++)
            {
                ...
                {
                    tyLeSK = (tour2Array[i].SoKhach / tour1Array[i].SoKhach * 100) ?? 0;
                }
                else
                {
                    tyLeSK = 0;
                ...
                if (doanhThu1 > 0)
                {
                    tyLeDoanhThu = (doanhThu2 / doanhThu1 * 100) ?? 0;
                }
        ...
        private IEnumerable<TourBaoCaoTheoThangViewModel> TourBaoCaoTheoThangViewModels_IB(string tuThang1, string denThang1, string nam1,
            Dmchinhanh chiNhanh, List<string> phongBans, string username)
        {
            ...
            IEnumerable<TourIBDTO> tourIBDTOs = _baoCaoService.DoanhSoTheoThang_IB(searchFromDate, searchToDate, chiNhanh, phongBans, username);
            ...
            string chiNhanh, string username)
        {
            ...
            //BaoCaoVM.TourBaoCaoDtos
            IEnumerable<TourNDDTO> TourNDDTOs = _baoCaoService.DoanhSoTheoThang_ND(searchFromDate, searchToDate, chiNhanh, username);
            ...
            string chiNhanh, string username)
        {
            ...
            //BaoCaoVM.TourBaoCaoDtos
            IEnumerable<TourOBDTO> TourOBDTOs = _baoCaoService.DoanhSoTheoThang_OB(searchFromDate, searchToDate, chiNhanh, username);
            ...
            string loaiTour = null, string maCn = null, string khoi = null)
        {
            ...
            try
            {
                ...
                if (searchFromDate == null || searchToDate == null)
                {
                    return View("DoanhSoTheoNgayDi", BaoCaoVM);
                }
                ...
                switch (khoi)
                {
                    case "IB":
                        if (user.RoleId == 8) // 8: admins: lay het
                        {
                            BaoCaoVM.TourIBDTOs = _baoCaoService.DoanhSoTheoNgay_IB(searchFromDate, searchToDate, loaiTour,
                                BaoCaoVM.Dmchinhanhs.FirstOrDefault(x => x.Macn == maCn), new List<string>(), "");
                    ...
                    case "ND":
                        maCn = maCn == "STN" ? "STS" : maCn;
                        BaoCaoVM.TourNDDTOs = user.RoleId == 9 ?
                            _baoCaoService.DoanhSoTheoNgay_ND(searchFromDate, searchToDate, loaiTour, maCn, user.Username) :
        ...
        [HttpPost]
        public async Task<IActionResult> DoanhSoTheoNgayDiExcel(string searchFromDate = null, string searchToDate = null,
            string loaiTour = null, string maCn = null, string khoi = null)
        {
            ...
            if (searchFromDate == null || searchToDate == null)
            {
                return RedirectToAction("DoanhSoTheoNgayDi");
            }
            try
            {
                DateTime.Parse(searchFromDate);
            ...
            switch (khoi)
            {
                ...
                case "IB":
                    if (BaoCaoVM.TourTheoNgay_IB.TourIBDTOs != null)
                    {
                        foreach (var item in BaoCaoVM.TourTheoNgay_IB.TourIBDTOs)
                        {
                            xlSheet.Cells[dong, 1].Value = idem;
                            TrSetCellBorder(xlSheet, dong, 1, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Justify, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            //xlSheet.Cells[dong, 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                            ...
                            xlSheet.Cells[dong, 9].Value = item.TenKh;// BaoCaoVM.Companies.FirstOrDefault(x => x.CompanyId == item.CompanyId).Name;//.CompanyName;
                        ...
                        TrSetCellBorder(xlSheet, dong, 5, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 6].Value = BaoCaoVM.TourTheoNgay_IB.TongSK;
                        TrSetCellBorder(xlSheet, dong, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 7].Value = BaoCaoVM.TourTheoNgay_IB.TongDS;
                        TrSetCellBorder(xlSheet, dong, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        ...
                        xlSheet.Cells[dong + 1, 6].Value = BaoCaoVM.TourTheoNgay_IB.TongSKCacDoanDaThanhLy;
                        ...
                        xlSheet.Cells[dong + 1, 7].Value = BaoCaoVM.TourTheoNgay_IB.TongDSCacDoanDaThanhLy;
                        ...
                        xlSheet.Cells[dong + 2, 6].Value = BaoCaoVM.TourTheoNgay_IB.TongSKCacDoanChuaThanhLy;
                        ...
                        xlSheet.Cells[dong + 2, 7].Value = BaoCaoVM.TourTheoNgay_IB.TongDSCacDoanChuaThanhLy;
                        ...
                        xlSheet.Cells[dong + 3, 6].Value = BaoCaoVM.TourTheoNgay_IB.TongSKCacDoanChuaKyHD;
                        ...
                        xlSheet.Cells[dong + 3, 7].Value = BaoCaoVM.TourTheoNgay_IB.TongDSCacDoanChuaKyHD;
                ...
                case "ND":
                    if (BaoCaoVM.TourTheoNgay_ND.TourNDDTOs != null)
                    {
                        foreach (var item in BaoCaoVM.TourTheoNgay_ND.TourNDDTOs)
                        {
                            xlSheet.Cells[dong, 1].Value = idem;
                            TrSetCellBorder(xlSheet, dong, 1, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Justify, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            //xlSheet.Cells[dong, 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                            ...
                            xlSheet.Cells[dong, 3].Value = item.Batdau.Value.ToShortDateString();
                            TrSetCellBorder(xlSheet, dong, 3, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Left, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            // xlSheet.Cells[dong, 3].Style.Border.Right.Style = ExcelBorderStyle.Thin;

                            xlSheet.Cells[dong, 4].Value = item.Ketthuc.Value.ToShortDateString();
                            TrSetCellBorder(xlSheet, dong, 4, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            //xlSheet.Cells[dong, 4].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                            ...
                            xlSheet.Cells[dong, 10].Value = item.Loaitourid;
                            TrSetCellBorder(xlSheet, dong, 10, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Left, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            // xlSheet.Cells[dong, 10].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                        ...
                        xlSheet.Cells[dong, 5].Value = "TỔNG CỘNG:";
                        TrSetCellBorder(xlSheet, dong, 5, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 6].Value = BaoCaoVM.TourTheoNgay_ND.TongSK;
                        TrSetCellBorder(xlSheet, dong, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 7].Value = BaoCaoVM.TourTheoNgay_ND.TongDS;
                        TrSetCellBorder(xlSheet, dong, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        ...
                        xlSheet.Cells[dong + 1, 5].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        xlSheet.Cells[dong + 1, 5].Style.Fill.BackgroundColor.SetColor(colorThanhLy);
                        xlSheet.Cells[dong + 1, 6].Value = BaoCaoVM.TourTheoNgay_ND.TongSKCacDoanDaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 1, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 1, 7].Value = BaoCaoVM.TourTheoNgay_ND.TongDSCacDoanDaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 1, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        ...
                        xlSheet.Cells[dong + 2, 5].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        xlSheet.Cells[dong + 2, 5].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                        xlSheet.Cells[dong + 2, 6].Value = BaoCaoVM.TourTheoNgay_ND.TongSKCacDoanChuaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 2, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 2, 7].Value = BaoCaoVM.TourTheoNgay_ND.TongDSCacDoanChuaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 2, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);

                        xlSheet.Cells[dong + 3, 5].Value = "Các đoàn chưa ký hợp đồng:";
                        TrSetCellBorder(xlSheet, dong + 3, 5, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);

                        xlSheet.Cells[dong + 3, 6].Value = BaoCaoVM.TourTheoNgay_ND.TongSKCacDoanChuaKyHD;
                        TrSetCellBorder(xlSheet, dong + 3, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 3, 7].Value = BaoCaoVM.TourTheoNgay_ND.TongDSCacDoanChuaKyHD;
                        TrSetCellBorder(xlSheet, dong + 3, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                ...
                case "OB":
                    if (BaoCaoVM.TourTheoNgay_OB.TourOBDTOs != null)
                    {
                        foreach (var item in BaoCaoVM.TourTheoNgay_OB.TourOBDTOs)
                        {
                            xlSheet.Cells[dong, 1].Value = idem;
                            TrSetCellBorder(xlSheet, dong, 1, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Justify, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            //xlSheet.Cells[dong, 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                        ...
                        xlSheet.Cells[dong, 5].Value = "TỔNG CỘNG:";
                        TrSetCellBorder(xlSheet, dong, 5, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 6].Value = BaoCaoVM.TourTheoNgay_OB.TongSK;
                        TrSetCellBorder(xlSheet, dong, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong, 7].Value = BaoCaoVM.TourTheoNgay_OB.TongDS;
                        TrSetCellBorder(xlSheet, dong, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        ...
                        xlSheet.Cells[dong + 1, 5].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        xlSheet.Cells[dong + 1, 5].Style.Fill.BackgroundColor.SetColor(colorThanhLy);
                        xlSheet.Cells[dong + 1, 6].Value = BaoCaoVM.TourTheoNgay_OB.TongSKCacDoanDaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 1, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 1, 7].Value = BaoCaoVM.TourTheoNgay_OB.TongDSCacDoanDaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 1, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        ...
                        xlSheet.Cells[dong + 2, 5].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        xlSheet.Cells[dong + 2, 5].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                        xlSheet.Cells[dong + 2, 6].Value = BaoCaoVM.TourTheoNgay_OB.TongSKCacDoanChuaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 2, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 2, 7].Value = BaoCaoVM.TourTheoNgay_OB.TongDSCacDoanChuaThanhLy;
                        TrSetCellBorder(xlSheet, dong + 2, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);

                        xlSheet.Cells[dong + 3, 5].Value = "Các đoàn chưa ký hợp đồng:";
                        TrSetCellBorder(xlSheet, dong + 3, 5, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Silver, "Times New Roman", 12, FontStyle.Regular);

                        xlSheet.Cells[dong + 3, 6].Value = BaoCaoVM.TourTheoNgay_OB.TongSKCacDoanChuaKyHD;
                        TrSetCellBorder(xlSheet, dong + 3, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                        xlSheet.Cells[dong + 3, 7].Value = BaoCaoVM.TourTheoNgay_OB.TongDSCacDoanChuaKyHD;
                        TrSetCellBorder(xlSheet, dong + 3, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
            ...
            try
            {
                ...
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "DoanhSoTheoNgayDi_IB_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");

                    case "ND":
                        return File(
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "DoanhSoTheoNgayDi_ND_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");

                    case "OB":
                        return File(
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "DoanhSoTheoNgayDi_OB_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");

                    default:
                        ViewBag.ErrorMessage = "An error occurred while processing your request. please contact administrator or redirect to home page.";
                        return NotFound();
                }
        ...
        [HttpPost]
        public async Task<IActionResult> DoanhSoTheoThiTruongExcel(string searchFromDate = null, string searchToDate = null,
            string thiTruong = null, string maCn = null, string khoi = null)
        {
                ...
                case "IB":
                    if (BaoCaoVM.TourTheoNgay_IB.TourIBDTOs != null)
                    {
                        foreach (var item in BaoCaoVM.TourTheoNgay_IB.TourIBDTOs)
                        {
                            ...
                            xlSheet.Cells[dong, 6].Value = (item.SoKhachTT == 0) ? item.SoKhachDK : item.SoKhachTT;
                            xlSheet.Cells[dong, 6].Style.Numberformat.Format = "#,##0";
                            TrSetCellBorder(xlSheet, dong, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            // xlSheet.Cells[dong, 8].Style.Border.Right.Style = ExcelBorderStyle.Thin;

                            xlSheet.Cells[dong, 7].Value = (item.DoanhThuTT == 0) ? item.DoanhThuDK : item.DoanhThuTT;
                            xlSheet.Cells[dong, 7].Style.Numberformat.Format = "#,##0";
                            TrSetCellBorder(xlSheet, dong, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Silver, "Times New Roman", 12, FontStyle.Regular);
                            //xlSheet.Cells[dong, 9].Style.Border.Right.Style = ExcelBorderStyle.Thin;
        ...
        private void DoanhSoTheoSaleGroupbyNguoiTao_IB()
        {
            ...
            foreach (var item in results1)
            {
                ...
                foreach (var itemDto in item.TourIBDTOs)
                {
                    ...
                    {
                        chuaThanhLyHopDong += itemDto.DoanhThuTT;// (itemDto.DoanhThuTT == 0) ? itemDto.DoanhThuDK : itemDto.DoanhThuTT;
                    }
                    else
                    {
                        daThanhLyHopDong += itemDto.DoanhThuTT;// (itemDto.DoanhThuTT == 0) ? itemDto.DoanhThuDK : itemDto.DoanhThuTT;
                    }
                }
        ...
        private void DoanhSoTheoSaleGroupbyNguoiTao_ND()
        {
            ...
            foreach (var item in results1)
            {
                ...
                //var tongCongTheoTungSale = chuaThanhLyHopDong + daThanhLyHopDong;
                // sokhach
                var soKhach = item.TourNDDTOs.Sum(x => x.Sokhachtt ?? 0); // == 0) ? x.Sokhachdk : x.Sokhachtt);
                ...
                foreach (var itemDto in item.TourNDDTOs)
                {
                    ...
                    if (ngayThanhLyHD == "01/01/0001" || string.IsNullOrEmpty(ngayThanhLyHD))
                    {
                        chuaThanhLyHopDong += itemDto.Doanhthutt ?? 0;// (itemDto.Doanhthutt == 0 || itemDto.Doanhthutt == null) ? itemDto.Doanhthudk : itemDto.Doanhthutt;
                    }
                    else
                    {
                        daThanhLyHopDong += itemDto.Doanhthutt ?? 0;// (itemDto.Doanhthutt == 0) ? itemDto.Doanhthudk : itemDto.Doanhthutt;
                    }
                }
        ...
        private void DoanhSoTheoSaleGroupbyNguoiTao_OB()
        {
            ...
            foreach (var item in results1)
            {
                ...
                //var tongCongTheoTungSale = chuaThanhLyHopDong + daThanhLyHopDong;
                // sokhach
                var soKhach = item.TourOBDTOs.Sum(x => x.Sokhachtt ?? 0); // == 0) ? x.Sokhachdk : x.Sokhachtt);
                ...
                foreach (var itemDto in item.TourOBDTOs)
                {
                    ...
                    if (ngayThanhLyHD == "01/01/0001" || string.IsNullOrEmpty(ngayThanhLyHD))
                    {
                        chuaThanhLyHopDong += itemDto.Doanhthutt ?? 0; // (itemDto.Doanhthutt == 0 || itemDto.Doanhthutt == null) ? temDto.Doanhthudk : itemDto.Doanhthutt;
                    }
                    else
                    {
                        daThanhLyHopDong += itemDto.Doanhthutt ?? 0; // (itemDto.Doanhthutt == 0 || itemDto.Doanhthutt == null) ? itemDto.Doanhthudk : itemDto.Doanhthutt;
                    }
                }
        ...
        {
            BaoCaoVM.TourTheoNgay_IB = new TourTheoNgay_IB();
        ...
        {
            BaoCaoVM.TourTheoNgay_ND = new TourTheoNgay_ND();
        ...
        {
            BaoCaoVM.TourTheoNgay_OB = new TourTheoNgay_OB();
