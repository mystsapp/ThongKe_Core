                    ...
                    if (!string.IsNullOrEmpty(khoi)) // luc chon khoi
                    {
                        switch (khoi)
                        {
                            case "IB":
                                ...
                                {
                                    BaoCaoVM.TourIBDTOs = _baoCaoService.DoanhSoTheoSale(searchFromDate, searchToDate, BaoCaoVM.Dmchinhanhs.Select(x => x.Macn).ToList());
                                    //DoanhSoTheoSaleGroupbyNguoiTao();
                                }
            ...
            string loaiTour = null, string maCn = null, string khoi = null)
        {
            ...
            else // admin tong
            {
                ...
                switch (khoi)
                {
                    ...
                    case "IB":
                        BaoCaoVM.Dmchinhanhs = string.IsNullOrEmpty(maCn) ? BaoCaoVM.Dmchinhanhs.ToList() : new List<Dmchinhanh>();
