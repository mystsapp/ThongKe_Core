...
namespace ThongKe.Data.Models_KDOB
{
    public partial class qlkdtrContext : DbContext
    {
        public qlkdtrContext()
        {
        }

        public qlkdtrContext(DbContextOptions<qlkdtrContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=118.68.170.128;database=qlkdtr;Trusted_Connection=true;User Id=vanhong;Password=Hong@2019;Integrated security=false;MultipleActiveResultSets=true");
//            }
        }
