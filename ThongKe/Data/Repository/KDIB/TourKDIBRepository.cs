...
namespace ThongKe.Data.Repository.KDIB
{
    ...
    public interface ITourKDIBRepository : IRepository<Tours>
    {
    ...
    public class TourKDIBRepository : Repository_KDIB<Tours>, ITourKDIBRepository
    {
        public TourKDIBRepository(SaleDoanIBContext context) : base(context)
        {
        }
